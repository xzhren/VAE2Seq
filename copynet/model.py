...
class VRAE:
    ...
    def _build_forward_graph(self):
        self._build_inputs()
        encoded_outputs, encoded_state = self._encode()
        self._decode(encoded_outputs, encoded_state)
    ...
    def _decode(self, encoder_outputs, encoded_state):
        self.training_rnn_out, self.training_logits = self._decoder_training(encoder_outputs, encoded_state)
        self.predicted_ids = self._decoder_inference(encoder_outputs, encoded_state)
    ...
    def _decoder_training(self, encoder_outputs, encoded_state):
        ...
        with tf.variable_scope('decoding'):
            ...
            decoder = ModifiedBasicDecoder(
                ...
                encoder_ouputs = encoder_outputs)
    ...
    def _decoder_inference(self, encoder_outputs, encoded_state):
        ...
        with tf.variable_scope('decoding', reuse=True):
            ...
            decoder = ModifiedBeamSearchDecoder(
                ...
                concat_z = tiled_z,
                encoder_ouputs = tiled_encoder_outputs)
            decoder_output, _, _ = tf.contrib.seq2seq.dynamic_decode(
                decoder = decoder,
